/**************************************************************************************************
  ...
  Description:    This file contains the Simple BLE Peripheral sample application
	...
	Generated by Musa ÇUFALCI 14.12.2018
...
#define DEFAULT_ADVERTISING_INTERVAL          1600 // Fatih 1sc
...
#define DEFAULT_DESIRED_MIN_CONN_INTERVAL     80 // Fatih default 80
...
// GAP GATT Attributes
static uint8 attDeviceName[GAP_DEVICE_NAME_LEN] = "Ortem BLE Peripheral";
...
void SimpleBLEPeripheral_Init( uint8 task_id )
{
  ...
  P0DIR = 0xFF; // Port 0 pins P0.0 and P0.1 as input (buttons),
                // all others (P0.2-P0.7) as output // Fatih Default 0xFC
  P1DIR = 0xFF; // All port 1 pins (P1.0-P1.7) as output
  P2DIR = 0x1F; // All port 1 pins (P2.0-P2.4) as output

  P0 = 0x02; // All pins on port 0 to low except for P0.0 and P0.1 (buttons) // Fatih Default 0x03
